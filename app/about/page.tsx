...
export const metadata: Metadata = {
  ...
  description:
    'A few words on House of Shakti and on Nancy Goodfellow, who built it: a sanctuary in Santa Teresa, Costa Rica, born from one simple question — how can we live, and feel, more alive?',
};
