...
// ─── Cloudbeds booking URL (placeholder; replaced in Phase 10) ───────────────
const CLOUDBEDS_URL = 'https://us2.cloudbeds.com/reservation/zE6Wy8';
...
function CheckAvailabilityLink({ label = 'Check availability', className = 'mt-6' }: { label?: string; className?: string }) {
  // CLOUDBEDS_BOOK_NOW_TRIGGER — replace with Cloudbeds immersive modal trigger in Phase 10
  return (
    <a
      href={CLOUDBEDS_URL}
      target="_blank"
