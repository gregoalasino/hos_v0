...
export function YTTIntro() {
  ...
  return (
    <section className="bg-warm-white py-20 lg:py-28 overflow-hidden">
      <div ref={ref} className="w-[90%] md:w-[80%] mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div>
          <motion.h2
            ...
            aria-label={HEADLINE}
            className="font-display font-light text-ink text-3xl md:text-4xl lg:text-5xl leading-[1.1] tracking-[-0.01em]"
          >
            {words.map((word, i) => (
          ...
          <motion.div
            ...
            className="mt-8 lg:mt-10 space-y-5"
          >
