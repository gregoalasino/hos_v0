        ...
        >
          {activities.map((activity) => (
            <motion.article key={activity.title} variants={card}>
              ...
              <p className="font-body text-[10px] tracking-[0.25em] uppercase text-ink mt-6 mb-3">
                {activity.eyebrow}
              </p>
              <h3 className="font-display font-light text-ink text-lg lg:text-xl leading-snug mb-3">
                {activity.title}
              </h3>
