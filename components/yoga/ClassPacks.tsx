...
// section above it.
// The three sizes; their cadence and note live in the catalogue under
// yoga.packs.sizes, keyed by the count.
const PACK_SIZES = ['5', '10', '20'] as const;
...
export function ClassPacks() {
  const t = useTranslations('yoga.packs');
